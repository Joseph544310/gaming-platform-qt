...
snakesandladders::snakesandladders(User *user, int gID)
{
    ...
    QString val;
    QFile file;
    file.setFileName("users/snakes&ladders.json");
    ...
    board->setPixmap((QPixmap("images/background2.png")));
    board->setPos(200,0);

    player1_pin = new QGraphicsPixmapItem();
    player1_pin->setPixmap((QPixmap("images/pin1.png")).scaled(40,40));
    player1_pin->setPos(200,595); // new bot left

    player2_pin = new QGraphicsPixmapItem();
    player2_pin->setPixmap((QPixmap("images/pin2.png")).scaled(40,40));
...
//    qWarning() << is_random;
    if (is_random) {
        ...
        snake1->setPixmap((QPixmap("images/snake1.png")).scaled(150,200));
...
//    snake2->setPixmap((QPixmap("images/snake2.png")).scaled(200,300));
//    snake2->setPos(108 + 65 * snake2_topxrand, 585 - 65 * snake2_topyrand);
    ...
    if(is_random) {
        ...
        snake3->setPixmap((QPixmap("images/snake3.png")).scaled(99,223));
    ...
    if(is_random) {
        ...
        snake4->setPixmap((QPixmap("images/snake4.png")).scaled(200,200));
    ...
    if(is_random) {
        ...
        ladder1->setPixmap((QPixmap("images/ladder1.png")).scaled(49,175));
    ...
    if(is_random) {
        ...
        ladder2->setPixmap((QPixmap("images/ladder2.png")).scaled(80,270));
    ...
    if(is_random) {
        ...
        ladder3->setPixmap((QPixmap("images/ladder3.png")).scaled(149,210));
